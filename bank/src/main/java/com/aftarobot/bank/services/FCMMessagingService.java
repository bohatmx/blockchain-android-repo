package com.aftarobot.bank.services;
...
public class FCMMessagingService extends FirebaseMessagingService {
    ...
    public static final String
            ...
            BROADCAST_FUNDS_TRANSFER_REQUEST = "com.aftarobot.BROADCAST_FUNDS_TRANSFER_REQUEST",
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData() != null) {
            ...
            if (type.equalsIgnoreCase("FUNDS_TRANSFER_REQUEST")) {
                FundsTransferRequest pol = GSON.fromJson(map.get("json"), FundsTransferRequest.class);
    ...
    private void broadcast(String intent, Data data) {
        ...
        if (data instanceof FundsTransferRequest) {
            m.putExtra("data", (FundsTransferRequest) data);
        }
    ...
    private void sendNotification(String messageType, String title, String json) {
        ...
        Intent resultIntent = new Intent(getApplicationContext(), BankMainActivity.class);
